...
# Table of Contents
1. [<pre>BoundedExponentialWeight                           (<: Weight) </pre>](#boundedexponentialweight)
...
1. [<pre>EqualWeight                                        (<: Weight) </pre>](#equalweight)
...
1. [<pre>HyperLogLog                                        (<: Any) </pre>](#hyperloglog)
1. [<pre>KMeans                                             (<: OnlineStat{VectorInput}) </pre>](#kmeans)
1. [<pre>LearningRate                                       (<: Weight) </pre>](#learningrate)
1. [<pre>LearningRate2                                      (<: Weight) </pre>](#learningrate2)
