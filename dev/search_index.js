...
{
    "location": "#Every-stat-is-:-OnlineStat{T}-1",
    "page": "Home",
...
{
    "location": "#Stats-can-be-updated-1",
    "page": "Home",
...
{
    "location": "#Stats-can-be-merged-1",
    "page": "Home",
...
{
    "location": "#Collections-of-Stats-1",
    "page": "Home",
...
{
    "location": "weights/#OnlineStatsBase.EqualWeight",
    "page": "Weights",
...
{
    "location": "weights/#OnlineStatsBase.ExponentialWeight",
    "page": "Weights",
...
{
    "location": "weights/#OnlineStatsBase.LearningRate",
    "page": "Weights",
...
{
    "location": "weights/#OnlineStatsBase.HarmonicWeight",
    "page": "Weights",
...
{
    "location": "weights/#OnlineStatsBase.McclainWeight",
    "page": "Weights",
...
{
    "location": "weights/#Weight-Types-1",
    "page": "Weights",
    "title": "Weight Types",
    "category": "section",
    "text": "EqualWeight\nExponentialWeight\nLearningRate\nHarmonicWeight\nMcclainWeight"
...
{
    "location": "weights/#OnlineStatsBase.Bounded",
    "page": "Weights",
...
{
    "location": "weights/#OnlineStatsBase.Scaled",
    "page": "Weights",
...
{
    "location": "weights/#Weight-wrappers-1",
    "page": "Weights",
...
{
    "location": "weights/#Custom-Weighting-1",
    "page": "Weights",
...
{
    "location": "stats_and_models/#Statistics-and-Models-1",
    "page": "Statistics and Models",
    "title": "Statistics and Models",
    "category": "section",
...
{
    "location": "parallel/#Parallel-Computation-1",
    "page": "Parallel Computation",
    "title": "Parallel Computation",
    "category": "section",
...
{
    "location": "parallel/#Exact-merges-1",
    "page": "Parallel Computation",
    "title": "Exact merges",
    "category": "section",
...
{
    "location": "parallel/#Other-Merges-1",
    "page": "Parallel Computation",
    "title": "Other Merges",
    "category": "section",
...
{
    "location": "plots/#Many-Stats-Can-Be-Plotted-via-Plot-Recipes-1",
    "page": "Plots",
...
{
    "location": "plots/#Naive-Bayes-Classifier-1",
    "page": "Plots",
...
{
    "location": "plots/#Continuous-Data-1",
    "page": "Plots",
...
{
    "location": "plots/#Plot-a-custom-function-of-the-OnlineStats-(default-is-value)-1",
    "page": "Plots",
...
{
    "location": "plots/#Categorical-Data-1",
    "page": "Plots",
...
{
    "location": "plots/#Indexed-Partitions-1",
    "page": "Plots",
...
{
    "location": "howfitworks/#How-fit!-Works-1",
    "page": "How fit! Works",
    "title": "How fit! Works",
    "category": "section",
...
{
    "location": "howfitworks/#Why-is-Fitting-Based-on-Iteration?-1",
    "page": "How fit! Works",
...
{
    "location": "howfitworks/#Reason-1:-OnlineStats-doesn\'t-want-to-make-assumptions-on-the-shape-of-your-data-1",
    "page": "How fit! Works",
...
{
    "location": "howfitworks/#Reason-2:-OnlineStats-naturally-works-out-of-the-box-with-many-data-structures-1",
    "page": "How fit! Works",
...
{
    "location": "howfitworks/#A-Common-Error-1",
    "page": "How fit! Works",
...
{
    "location": "api/#OnlineStats.ADADELTA",
    "page": "API",
...
{
    "location": "api/#OnlineStats.ADAGRAD",
    "page": "API",
...
{
    "location": "api/#OnlineStats.ADAMAX",
    "page": "API",
...
{
    "location": "api/#OnlineStats.AutoCov",
    "page": "API",
...
{
    "location": "api/#OnlineStats.BiasVec",
    "page": "API",
...
{
    "location": "api/#OnlineStats.Bootstrap",
    "page": "API",
...
{
    "location": "api/#OnlineStats.CallFun",
    "page": "API",
...
{
    "location": "api/#OnlineStats.CountMap",
    "page": "API",
...
{
    "location": "api/#OnlineStats.CovMatrix",
    "page": "API",
...
{
    "location": "api/#OnlineStats.FastTree",
    "page": "API",
...
{
    "location": "api/#OnlineStats.FitBeta",
    "page": "API",
...
{
    "location": "api/#OnlineStats.FitCauchy",
    "page": "API",
...
{
    "location": "api/#OnlineStats.FitGamma",
    "page": "API",
...
{
    "location": "api/#OnlineStats.FitLogNormal",
    "page": "API",
...
{
    "location": "api/#OnlineStats.FitMultinomial",
    "page": "API",
...
{
    "location": "api/#OnlineStats.FitMvNormal",
    "page": "API",
...
{
    "location": "api/#OnlineStats.FitNormal",
    "page": "API",
...
{
    "location": "api/#OnlineStats.Group",
    "page": "API",
...
{
    "location": "api/#OnlineStats.GroupBy",
    "page": "API",
...
{
    "location": "api/#OnlineStats.HeatMap",
    "page": "API",
...
{
    "location": "api/#OnlineStats.HyperLogLog",
    "page": "API",
...
{
    "location": "api/#OnlineStats.IndexedPartition",
    "page": "API",
...
{
    "location": "api/#OnlineStats.KHist",
    "page": "API",
...
{
    "location": "api/#OnlineStats.KMeans",
    "page": "API",
...
{
    "location": "api/#OnlineStats.KahanMean",
    "page": "API",
...
{
    "location": "api/#OnlineStats.KahanSum",
    "page": "API",
...
{
    "location": "api/#OnlineStats.KahanVariance",
    "page": "API",
...
{
    "location": "api/#OnlineStats.LinReg",
    "page": "API",
...
{
    "location": "api/#OnlineStats.LinRegBuilder",
    "page": "API",
...
{
    "location": "api/#OnlineStats.Mosaic",
    "page": "API",
...
{
    "location": "api/#OnlineStats.MovingTimeWindow",
    "page": "API",
...
{
    "location": "api/#OnlineStats.MovingWindow",
    "page": "API",
...
{
    "location": "api/#OnlineStats.NBClassifier",
    "page": "API",
...
{
    "location": "api/#OnlineStats.OrderStats",
    "page": "API",
...
{
    "location": "api/#OnlineStats.P2Quantile",
    "page": "API",
...
{
    "location": "api/#OnlineStats.Partition",
    "page": "API",
...
{
    "location": "api/#OnlineStats.PlotNN",
    "page": "API",
...
{
    "location": "api/#OnlineStats.ProbMap",
    "page": "API",
...
{
    "location": "api/#OnlineStats.Quantile",
    "page": "API",
...
{
    "location": "api/#OnlineStats.RMSPROP",
    "page": "API",
...
{
    "location": "api/#OnlineStats.ReservoirSample",
    "page": "API",
...
{
    "location": "api/#OnlineStats.StatLearn",
    "page": "API",
...
{
    "location": "api/#StatsBase.confint",
    "page": "API",
...
{
    "location": "api/#OnlineStats.Cluster",
    "page": "API",
