...
obj = onlinefit(Bernoulli, x1)
@test obj.d.p == mean(x1)
@test obj.stats.cnt0 == sum(x1 .== 0)
@test obj.stats.cnt1 == sum(x1 .== 1)
@test obj.n == n1
@test obj.nb == 1

OnlineStats.update!(obj, x2)
@test obj.d.p == mean(x)
@test obj.stats.cnt0 == sum(x .== 0)
@test obj.stats.cnt1 == sum(x .== 1)
@test obj.n == n1 + n2
@test obj.nb == 2
...
@test obj.stats.mean == mean(x1)
@test obj.stats.var == var(x1)
@test obj.n == n1
@test obj.nb == 1

OnlineStats.update!(obj, x2)
@test_approx_eq obj.stats.mean mean(x)
@test_approx_eq obj.stats.var var(x)
@test obj.n == n1 + n2
@test obj.nb == 2
