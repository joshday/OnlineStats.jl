...
# # This was copied nearly verbatim from StreamStats.jl
...
#     E_star
# end
# value(o::HyperLogLog) = estimatedCardinality(o)
#
#
#
# #---------------------------------------------------------------------# fit!
...
#
#
# function StatsBase.fit!(o::HyperLogLog, v::Real)
#     x = hash32(v)
...
# end
#
# function StatsBase.fit!{T<:Real}(o::HyperLogLog, V::AVec{T})
#     for v in V
#         fit!(o, v)
#     end
# end
