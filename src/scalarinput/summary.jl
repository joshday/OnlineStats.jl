#--------------------------------------------------------------------# Mean
mutable struct Mean <: OnlineStat{ScalarIn, ScalarOut}
    μ::Float64
    Mean() = new(0.0)
end
...
#--------------------------------------------------------------------# OrderStats
mutable struct OrderStats <: OnlineStat{ScalarIn, VectorOut}
    value::VecF
    buffer::VecF
    i::Int
    nreps::Int
...
#--------------------------------------------------------------------# QuantileSGD
mutable struct QuantileMM <: OnlineStat{ScalarIn, VectorOut}
    value::VecF
    τ::VecF
