struct ColSummary{T <: Union{Variance, CountMap}}
    stat::T 
    hasmissing::Bool
end
ColSummary(stat::Union{Variance, CountMap}) = ColSummary(stat, false)

fit!(o::ColSummary, y, γ::Number) = fit!(o.stat, y, γ)

#-----------------------------------------------------------------------# continuous
width(o::ColSummary{Variance}) = 1 + o.hasmissing

function Base.show(io::IO, o::ColSummary{Variance})
    print(io)
end 

#-----------------------------------------------------------------------# categorical
width(o::ColSummary{<:CountMap}) = length(o.stat) + o.hasmissing
