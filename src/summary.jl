...
set_sample_weight!(b::Mean, ow::ObsWeight) = set_sample_weight!(o.weight, ow)
...
set_sample_weight!(b::Means, ow::ObsWeight) = set_sample_weight!(o.weight, ow)
...
set_sample_weight!(b::Variance, ow::ObsWeight) = set_sample_weight!(o.weight, ow)
...
set_sample_weight!(b::Variances, ow::ObsWeight) = set_sample_weight!(o.weight, ow)
